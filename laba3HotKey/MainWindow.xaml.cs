...
namespace laba3HotKey
{
    public partial class MainWindow : Window
    {
        ...
        private void AddButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            string patronemic = PatronemicTextBox.Text;
            string lastName = LastNameTextBox.Text;
            string dateOfBirth = DateOfBirthTextBox.Text;
            string faculty = FacultyTextBox.Text;
            string group = GroupTextBox.Text;

            Student newStudent = new Student(firstName, patronemic, lastName, dateOfBirth, faculty, group);
        ...
        private void StudentsListBox_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (StudentsListBox.SelectedItem != null)
            {
                ...
                PatronemicTextBox.Text = selectedStudent.Patronymic;
        ...
        private void Window_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                if (StudentsListBox.SelectionMode == SelectionMode.Multiple || StudentsListBox.SelectionMode == SelectionMode.Extended)
                {
                ...
                using (System.IO.StreamReader file = new System.IO.StreamReader(filePath))
                {
                    ...
                    while ((line = file.ReadLine()) != null)
                    {
                        ...
                        if (studentInfo.Length == 6)
                        {
                            ...
                            Student loadedStudent = new Student(firstName, patronymic, lastName, dateOfBirth, faculty, group);
        ...
        private void PasteCommandExecuted(object sender, ExecutedRoutedEventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(copiedText))
            {
                ...
                if (studentInfo.Length == 6)
                {
                    ...
                    Student copiedStudent = new Student(firstName, patronymic, lastName, dateOfBirth, faculty, group);
                    students.Add(copiedStudent);
                }
            }
        }
    ...
    public class Student
    {
        ...
        public Student(string firstName, string patronemic, string lastName, string dateOfBirth, string faculty, string group)
        {
            FirstName = firstName;
